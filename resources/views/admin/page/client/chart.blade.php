        ...
        <div class="card-body">
            <div class="card shadow">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Statistique des réservation</h6>
                </div>
                <div class="card-body">
...
@foreach ($article as $items)
    <input type="hidden" name="" value="{{ $nbart }}" class="ecolage">
    <input type="hidden" name="" value="{{ $items->created_at }}" class="mois">
@endforeach
@foreach ($user as $item)
<input type="hidden" name="" value="{{ $nbClt }}" class="ecolage">
<input type="hidden" name="" value="{{ $item->created_at }}" class="mois">
@endforeach
<script>
